...
// logos-transport) inside a foreground service. No IPC yet — this just proves the node
// comes up in its own app and survives backgrounding. AIDL (so other apps bind) is next.
...
export default function App() {
  ...
  return (
    <View style={s.c}>
      ...
      <View style={s.card}><Text style={s.status}>{status}</Text><Text style={s.info}>{info}</Text></View>
